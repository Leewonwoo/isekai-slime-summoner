#!/usr/bin/env python3
"""Create deterministic Unity Point-filtered single-sprite metadata for UI icons."""
...
def main() -> None:
    ...
    for png in sorted(args.asset_root.rglob("*.png")):
        ...
        print(f"{png.relative_to(args.asset_root)}: {guid}")
