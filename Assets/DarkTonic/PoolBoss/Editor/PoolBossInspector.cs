...
namespace DarkTonic.PoolBoss.EditorScript
{
    ...
    public class PoolBossInspector : Editor
    {
        ...
        private void AddPoolItem(Object o)
        {
            ...
            var existingPoolableInfo = go.GetComponent<PoolableInfo>();
            if (existingPoolableInfo != null) {
                DestroyImmediate(existingPoolableInfo, true); // clear out potential wrong name
            }
